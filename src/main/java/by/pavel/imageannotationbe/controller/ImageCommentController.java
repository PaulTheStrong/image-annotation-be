...
public class ImageCommentController {
    ...
    @GetMapping
    public List<ImageCommentDto> getComments(@PathVariable Long projectId, @PathVariable Long imageId) {
    ...
    public void removeComment(@PathVariable Long projectId, @PathVariable Long imageId, @PathVariable Long commentId) {
